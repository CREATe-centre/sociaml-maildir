            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Sociaml_maildir"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "sociaml_maildir";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("maildir", None);
                           InternalLibrary "sociaml_maildir"
                        ];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                   ...
                   {
                      lib_modules = ["Filesystem"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "sociaml_maildir";
                      lib_findlib_name = Some "filesystem";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Irminstore"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "sociaml_maildir";
                      lib_findlib_name = Some "irminstore";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/sociaml-maildir";
                      doc_title = "sociaml-maildir Reference";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dominicjprice/sociaml-maildir.git";
                      src_repo_browser =
                        Some
                          "https://github.com/dominicjprice/sociaml-maildir";
